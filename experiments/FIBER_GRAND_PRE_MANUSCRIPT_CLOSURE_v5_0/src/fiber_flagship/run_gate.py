...
def run(profile_name: str) -> dict:
    ...
    print("[E3] C++20 pre-manuscript closure: FIBER versus enabled prefix A* and syndrome-trellis baselines...")
    ...
    print("[E6] Frozen pre-manuscript closure decision...")
    ...
    (results_dir / "ANALYSIS_HANDOFF.md").write_text(
        ...
        "A positive result authorizes freezing the full IEEE TIT manuscript and a minimal external-review package. It does not establish field-defining impact or real-system value.\n",
        encoding="utf-8",
    )
